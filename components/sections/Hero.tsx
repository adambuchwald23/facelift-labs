...
export default function Hero() {
  ...
  return (
    <section
      id="about"
      className="relative w-full flex flex-col items-center overflow-x-clip scroll-mt-24 min-h-[calc(100svh-4rem)]"
    >
      ...
      {/* Hero content */}
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-1 flex-col justify-center px-5 pb-10 sm:px-6 sm:pb-20 md:pb-24">
